...
def tik():
    titik = [
     '.   ', '..  ', '... ', '....', '.....']
    for o in titik:
        print '\r\x1b[1;91m[\xe2\x97\x8f] \x1b[1;92mSedang Masuk Gan Tunggu Bentar \x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(1)
...
def login():
    ...
    try:
        ...
        try:
            ...
            print '\n\x1b[1;91m[!] Tidak ada koneksi gayn'
            keluar()
...
def menu():
    ...
    print '\x1b[1;37;40m2. Hack Facebook Target'
